...
if ( get_option( 'db_upgraded' ) ) {
	 ...
	 *
	 * In single site, the user would be redirected to panel/upgrade.php.
	...
	if ( apply_filters( 'do_mu_upgrade', true ) ) {
		...
		if ( $c <= 50 || ( $c > 50 && mt_rand( 0, (int) ( $c / 50 ) ) === 1 ) ) {
			...
			/** This action is documented in panel/network/upgrade.php */
...
require_once ABSPATH . 'panel/includes/admin.php';
 ...
 * $wp_importers is sometimes set in panel/includes/import.php
...
if ( WP_NETWORK_ADMIN ) {
	require ABSPATH . 'panel/network/menu.php';
} elseif ( WP_USER_ADMIN ) {
	require ABSPATH . 'panel/user/menu.php';
} else {
	require ABSPATH . 'panel/menu.php';
}
...
if ( isset( $plugin_page ) ) {
	...
	require_once ABSPATH . 'panel/includes/upgrade.php';
