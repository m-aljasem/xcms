...
require_once ABSPATH . 'panel/includes/class-walker-nav-menu-edit.php';

/** Walker_Nav_Menu_Checklist class */
require_once ABSPATH . 'panel/includes/class-walker-nav-menu-checklist.php';
...
function wp_nav_menu_update_menu_items( $nav_menu_selected_id, $nav_menu_selected_title ) {
	...
	/** This action is documented in vendor/nav-menu.php */
