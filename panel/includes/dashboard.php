...
function wp_dashboard_setup() {
	...
	if ( 'POST' === $_SERVER['REQUEST_METHOD'] && isset( $_POST['widget_id'] ) ) {
		...
		ob_start(); // Hack - but the same hack panel/widgets.php uses.
	...
	/** This action is documented in panel/includes/meta-boxes.php */
 ...
 * which is later replaced by Ajax call (see top of /panel/index.php)
 *
 * @since 2.5.0
