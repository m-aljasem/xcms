...
class WP_Site_Health {
	...
	public function get_test_background_updates() {
		...
		if ( ! class_exists( 'WP_Site_Health_Auto_Updates' ) ) {
			require_once ABSPATH . 'panel/includes/class-wp-site-health-auto-updates.php';
		}
	...
	public function get_test_rest_availability() {
		...
		/** This filter is documented in vendor/class-wp-http-streams.php */
	...
	public static function get_tests() {
		 ...
		 * to complete should run asynchronously, to avoid extended loading periods within panel.
		 *
		 * @since 5.2.0
		 *
	...
	function detect_plugin_theme_auto_update_issues() {
		...
		$type = 'plugin';
		/** This filter is documented in panel/includes/class-wp-automatic-updater.php */
	...
	public function wp_cron_scheduled_check() {
		// Bootstrap panel, as WP_Cron doesn't do this for us.
		require_once trailingslashit( ABSPATH ) . 'panel/includes/admin.php';
