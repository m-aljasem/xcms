		...
		if ( is_multisite() && get_site_option( 'ms_files_rewriting' ) ) {
			...
			$web_config_file .= '
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . 'panel$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . 'panel/" redirectType="Permanent" />
                </rule>
...
{$ms_files_rewriting}
# add a trailing slash to /panel
RewriteRule ^{$subdir_match}panel$ {$subdir_replacement_01}panel/ [R=301,L]
