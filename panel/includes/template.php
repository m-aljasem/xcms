...
require_once ABSPATH . 'panel/includes/class-walker-category-checklist.php';

/** WP_Internal_Pointers class */
require_once ABSPATH . 'panel/includes/class-wp-internal-pointers.php';
	...
	foreach ( (array) $terms as $term ) {
		...
		<li id="<?php echo $id; ?>" class="popular-category">
			<label class="selectit">
				...
				<?php
				/** This filter is documented in vendor/category-template.php */
...
<div class="hidden" id="inline_' . $post->ID . '">
	...
	/** This filter is documented in panel/edit-tag-form.php */
...
var ajaxurl = '<?php echo esc_js( admin_url( 'admin-ajax.php', 'relative' ) ); ?>',
	...
	<?php
	/** This action is documented in panel/admin-header.php */
	...
	/** This filter is documented in panel/admin-header.php */
	$admin_body_classes = apply_filters( 'admin_body_class', '' );
	$admin_body_classes = ltrim( $admin_body_classes . ' ' . $admin_body_class );
	?>
<body <?php echo $admin_body_id; ?>class="panel wp-core-ui no-js iframe <?php echo $admin_body_classes; ?>">
<script type="text/javascript">
(function(){
...
function iframe_footer() {
	...
	<div class="hidden">
	<?php
	/** This action is documented in panel/admin-footer.php */
