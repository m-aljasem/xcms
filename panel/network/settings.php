...
require_once ABSPATH . 'panel/includes/translation-install.php';
...
if ( $_POST ) {
	/** This action is documented in panel/network/edit.php */
...
<?php require_once ABSPATH . 'panel/admin-footer.php'; ?>
