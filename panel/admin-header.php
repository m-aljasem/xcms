...
if ( $error_get_last && WP_DEBUG && WP_DEBUG_DISPLAY && ini_get( 'display_errors' )
	...
	// and should not be displayed with the `error_reporting` level previously set in loader.php.
 ...
 * 2. Not all core admin classes are filterable, notably: panel, wp-core-ui,
...
?>
<body class="panel wp-core-ui no-js <?php echo $admin_body_classes; ?>">
<script type="text/javascript">
...
<div id="wpwrap">
<?php require ABSPATH . 'panel/menu-header.php'; ?>
<div id="wpcontent">
...
if ( 'options-general.php' === $parent_file ) {
	require ABSPATH . 'panel/options-head.php';
}
