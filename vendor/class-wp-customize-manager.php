...
final class WP_Customize_Manager {
	...
	public function validate_setting_values( $setting_values, $options = array() ) {
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! is_wp_error( $validity ) ) {
				/** This filter is documented in vendor/class-wp-customize-setting.php */
	...
	public function trash_changeset_post( $post ) {
		...
		/** This filter is documented in vendor/post.php */
		$check = apply_filters( 'pre_trash_post', null, $post );
		if ( null !== $check ) {
			return $check;
		}

		/** This action is documented in vendor/post.php */
	...
	public function add_setting( $id, $args = array() ) {
		if ( $id instanceof WP_Customize_Setting ) {
			...
			/** This filter is documented in vendor/class-wp-customize-manager.php */
	...
	public function get_return_url() {
		...
		$excluded_referer_basenames = array( 'customize.php', 'auth.php' );
	...
	public function handle_load_themes_request() {
		...
		if ( 'installed' === $theme_action ) {
			...
			// This list matches the allowed tags in panel/includes/theme-install.php.
