...
function wp_not_installed() {
	if ( is_multisite() ) {
		...
		$link = wp_guess_url() . '/panel/install.php';
...
function is_protected_endpoint() {
	// Protect login pages.
	if ( isset( $GLOBALS['pagenow'] ) && 'auth.php' === $GLOBALS['pagenow'] ) {
		return true;
	}
...
function wp_is_jsonp_request() {
	...
	/** This filter is documented in vendor/rest-api/class-wp-rest-server.php */
