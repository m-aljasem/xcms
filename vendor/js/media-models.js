...
/**
 * @output vendor/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `vendor/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `vendor/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `vendor/js/wp-util.js`.
	 *
