 ...
 * at panel/network/settings.php. The check is only run on
 * self-registrations; user creation at panel/network/users.php
 * bypasses this check.
 *
 * @since MU (3.0.0)
 *
...
function wpmu_validate_user_signup( $user_name, $user_email ) {
	...
	/** This filter is documented in vendor/user.php */
 ...
 * which is defined in vendor/functions.php in
 * get_allowed_mime_types(). This function is used to filter
 * that list against the filetypes allowed provided by Multisite
 * Super Admins at panel/network/settings.php.
 *
 * @since MU (3.0.0)
 *
 * @param array $mimes
...
function wp_maybe_update_network_user_counts( $network_id = null ) {
	...
	/** This filter is documented in vendor/ms-functions.php */
...
function get_subdirectory_reserved_names() {
	 ...
	 *
	 * @since 3.0.0
	 * @since 4.4.0 'panel', 'wp-content', 'vendor', 'wp-json', and 'embed' were added
