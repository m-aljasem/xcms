...
function redirect_canonical( $requested_url = null, $do_redirect = true ) {
	...
	// If we're not in panel and the post has been published and preview nonce
 ...
 *
 * If a user visits example.com/admin, they'll be redirected to /panel.
 * Visiting /login redirects to /auth.php, and so on.
 *
 * @since 3.4.0
 *
 * @global WP_Rewrite $wp_rewrite WordPress rewrite component.
