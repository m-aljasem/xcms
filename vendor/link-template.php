...
function get_search_comments_feed_link( $search_query = '', $feed = '' ) {
	...
	/** This filter is documented in vendor/link-template.php */
...
function get_home_url( $blog_id = null, $path = '', $scheme = null ) {
	...
	if ( ! in_array( $scheme, array( 'http', 'https', 'relative' ), true ) ) {
		if ( is_ssl() && ! is_admin() && 'auth.php' !== $pagenow ) {
			$scheme = 'https';
		} else {
 ...
 * (e.g. site-header.php or the panel/ folder) are accessible.
 *
...
function get_admin_url( $blog_id = null, $path = '', $scheme = 'admin' ) {
	$url = get_site_url( $blog_id, 'panel/', $scheme );
...
function includes_url( $path = '', $scheme = null ) {
	 ...
	 * @param string $path Path relative to the URL to the vendor directory. Blank string
...
function network_admin_url( $path = '', $scheme = 'admin' ) {
	...
	$url = network_site_url( 'panel/network/', $scheme );
...
function user_admin_url( $path = '', $scheme = 'admin' ) {
	$url = network_site_url( 'panel/user/', $scheme );
