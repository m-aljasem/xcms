...
function wp_schedule_single_event( $timestamp, $hook, $args = array() ) {
	 ...
	 *
	 * For plugins replacing cron.php, it is recommended you check for an
...
function wp_schedule_event( $timestamp, $recurrence, $hook, $args = array() ) {
	...
	/** This filter is documented in vendor/cron.php */
	$pre = apply_filters( 'pre_schedule_event', null, $event );
	if ( null !== $pre ) {
		return $pre;
	}
...
function wp_reschedule_event( $timestamp, $recurrence, $hook, $args = array() ) {
	 ...
	 *
	 * For plugins replacing cron.php, return true if the event was successfully
...
function wp_clear_scheduled_hook( $hook, $args = array() ) {
	 ...
	 * process, causing the function to return the filtered value instead.
	 *
	 * For plugins replacing cron.php, return the number of events successfully
