...
function wp_loginout( $redirect = '', $echo = true ) {
	...
	if ( $echo ) {
		...
		/** This filter is documented in vendor/general-template.php */
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'auth.php', 'login_post' ) ) . '" method="post">
			' . $login_form_top . '
			...
			foreach ( (array) $results as $result ) {
				if ( '0000-00-00 00:00:00' !== $result->post_date ) {
					...
					if ( $result->post_title ) {
						/** This filter is documented in vendor/post-template.php */
...
function wp_resource_hints() {
	 ...
	 */
	/** This filter is documented in vendor/formatting.php */
 ...
 * See wp.editor.initialize() in panel/js/editor.js for initialization options.
 *
 * @uses _WP_Editors
 * @since 4.8.0
 */
 ...
 * @since 2.3.0
 *
 * @param string $file file relative to panel/ without its ".css" extension.
 * @return string
 */
function wp_admin_css_uri( $file = 'panel' ) {
 ...
 * $file is a file relative to panel/ without its ".css" extension. A
 * stylesheet link to that generated URL is printed.
 *
 * @since 2.3.0
 *
 * @param string $file       Optional. Style handle name or file name (without ".css" extension) relative
 *                           to panel/. Defaults to 'panel'.
 * @param bool   $force_echo Optional. Force the stylesheet link to be printed rather than enqueued.
 */
function wp_admin_css( $file = 'panel', $force_echo = false ) {
	 ...
	 *                                relative to panel/. Defaults to 'panel'.
	 */
