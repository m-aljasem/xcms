...
class Kirki_Util {
	...
	public static function is_plugin() {
		...
		if ( ! function_exists( 'get_plugins' ) ) {
			require_once ABSPATH . 'panel/includes/plugin.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude
		}
		...
		include_once ABSPATH . 'panel/includes/plugin.php'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude
